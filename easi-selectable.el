...
(cl-defgeneric easi-selectable-documentation (selectable)
  "Get documentation of SELECTABLE.")

(cl-defmethod easi-selectable-documentation ((selectable easi-selectable))
  (slot-value selectable 'documentation))
